...
public class Dibuja {
    ...
    public void dibuja_uno(GraphicsContext gc, ArrayList<String> operacion){
    ...
    public void dibuja_dos(GraphicsContext gc ,ArrayList<String> operacion){
      if(operacion.isEmpty()){ 
        ...
        public void dibuja_tres(GraphicsContext gc, ArrayList<String> operacion){
        ...
        if(operacion.isEmpty()){
          ...
          public void dibuja_cuatro(GraphicsContext gc, ArrayList<String> operacion){
    ...
    public void dibuja_cinco(GraphicsContext gc, ArrayList<String> operacion){
        ...
        public void dibuja_seis(GraphicsContext gc, ArrayList<String> operacion){
       ...
       if(operacion.isEmpty()){
        ...
        public void dibuja_siete(GraphicsContext gc, ArrayList<String> operacion){
      ...
      if(operacion.isEmpty()){
       ...
       public void dibuja_ocho(GraphicsContext gc, ArrayList<String> operacion){
      ...
      if(operacion.isEmpty()){
       ...
       public void dibuja_nueve(GraphicsContext gc, ArrayList<String> operacion){
      ...
      if(operacion.isEmpty()){
       ...
       public void dibuja_cero(GraphicsContext gc, ArrayList<String> operacion){
      ...
      if(operacion.isEmpty()){
       ...
       public void dibuja_mas(GraphicsContext gc, ArrayList<String> operacion){
       ...
       mx = mx + 35;
        ...
        public void dibuja_menos(GraphicsContext gc, ArrayList<String> operacion){
       ...
       mx = mx + 35;
        ...
        public void dibuja_x(GraphicsContext gc, ArrayList<String> operacion){
       ...
       mx = mx + 35;
        ...
        public void dibuja_parentesisI(GraphicsContext gc, ArrayList<String> operacion){
        ...
        public void dibuja_parentesisD(GraphicsContext gc, ArrayList<String> operacion){
        ...
        public void dibuja_dividir(GraphicsContext gc, ArrayList<String> operacion){
         gc.strokeLine(mx -30,80,mx + 10,80);
         mx = mx - 35;
    }
